...
**Itération :** Aucune ; premier jet retenu et committé dans `docs/vpc.md`.
...
**Itération :** Une itération : premier brouillon encore trop proche du HMW S1 (gardait une référence implicite au canal) ; reformulation demandée pour retirer toute mention de solution, aboutissant à la version définitive committée dans `docs/hmw-definitif.md`.
